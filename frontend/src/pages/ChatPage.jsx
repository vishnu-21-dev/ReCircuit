    ...
    <div className="bg-gradient-to-br from-gray-950 via-green-950 to-gray-900 min-h-screen flex flex-col">
      ...
      <div className="p-4 border-b border-white/10 bg-black/20">
        <div className="flex items-center gap-3">
          ...
          {matchData.grade && (
            <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold border ${matchData.grade === 'A' ? 'bg-green-500/20 text-green-400 border-green-500/30' :
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden relative">
        {/* Pinned AI Verification Report Dashboard */}
        {(matchData.videoUrl || matchData.aiPriceSuggestion || matchData.aiGradeVerifyResult || matchData.aiFakeCheckResult || matchData.aiRecognitionResult) && (
          <div className="flex flex-col border-b lg:border-b-0 lg:border-r border-white/10 bg-black/10 lg:w-[45%] xl:w-2/5 shrink-0 max-h-[50vh] lg:max-h-none">
            {/* Mobile Toggle */}
            <button
              onClick={() => setIsReportExpanded(!isReportExpanded)}
              className="lg:hidden flex items-center justify-between w-full p-3 bg-green-500/10 text-green-400 font-bold text-sm border-b border-green-500/20"
            >
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
                <span>{isReportExpanded ? 'Hide' : 'View'} AI Verification Report</span>
              </div>
              <svg className={`w-4 h-4 transform transition-transform duration-200 ${isReportExpanded ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" /></svg>
            </button>

            <div className={`flex-1 overflow-y-auto p-4 ${isReportExpanded ? 'block' : 'hidden lg:block'}`}>
              <div className="bg-black/40 border border-green-500/30 rounded-xl p-4 shadow-lg relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm relative z-10">
                  ...
                  <div className="space-y-3">
                    ...
                    {matchData.imageUrl && (
                      <div>
                        <h3 className="text-gray-400 font-semibold mb-2 uppercase tracking-wide text-xs">Verification Photo</h3>
                        <img src={matchData.imageUrl} alt="Part Verification" className="w-full rounded-lg border border-white/10 bg-black aspect-video object-contain" />
                      </div>
                    )}
                        ...
                        <div className="space-y-1.5">
                          ...
                          {matchData.aiRecognitionResult.grade && (
                            <div className="flex justify-between items-center">
                              ...
                              <span className={`text-xs font-bold px-2 py-0.5 rounded ${matchData.aiRecognitionResult.grade === 'A' ? 'bg-green-500/20 text-green-400' :
                          ...
                          <div className="flex justify-between items-center pt-1 border-t border-white/10 mt-2">
                            ...
                            <span className={`text-[10px] px-1.5 py-0.5 rounded font-bold ${matchData.aiRecognitionResult.confidence === 'high' ? 'bg-green-500/20 text-green-400' :
                  ...
                  <div className="space-y-3">
                    ...
                    {matchData.aiFakeCheckResult && (
                      <div className={`rounded-lg p-3 border ${matchData.aiFakeCheckResult.isFake ? 'bg-red-500/10 border-red-500/30' :
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-transparent">
          ...
          {/* Bottom input bar */}
          <div className="p-4 bg-black/40 backdrop-blur-md border-t border-white/10 flex flex-col items-center w-full">
